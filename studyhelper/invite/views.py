...
def home(request):
    ...
    return render(request, 'invite/home.html', context=context)
...
def user_home(request):
    ...
    return render(request, 'invite/user_home.html', context=context)
...
def leaderboard(request):
    ...
    return render(request, 'invite/leaderboard.html', context=context)
    ...
    if request.user.is_superuser:
        if request.method == "GET":
            ...
            if course_id:
                ...
                return render(request, 'invite/import_export.html', context=context)
...
def play(request):
    ...
    if request.method == 'POST' and request.POST.get('question_pk'):
        ...
        return render(request, 'invite/play.html', context=context)
...
def submission_result(request, attempted_question_pk):
    ...
    return render(request, 'invite/submission_result.html', context=context)
...
def session_result(request, session_score_id):
    ...
    return render(request, 'invite/session_result.html', context=context)
...
def user_results(request, user_id):
    ...
    return render(
        request,
        'invite/list_profile_results.html',
        context={
